...
module Essenfont
  module Coverage
    # Report: per-block coverage computation for a set of codepoints.
    #
    ...
    #
    # @example Basic usage
    #   report = Essenfont::Coverage::Report.new(cmap_codepoints)
    ...
    #   report = Essenfont::Coverage::Report.new(cmap_cps, assigned_filter: assigned_set)
    #
    class Report
